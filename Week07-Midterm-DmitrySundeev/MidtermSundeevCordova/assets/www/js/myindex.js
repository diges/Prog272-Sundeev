var MongoData = (function() { 'use strict';
	...
	var readData = function() {
		$.getJSON('http://192.168.0.10:30025/readAll', function(data) {
			console.log(data);
			$("#resultsDebug").empty();
			$("#select").empty();
	...
	var queryFiltered = function() {
		...
		$.getJSON('http://192.168.0.10:30025/keyword/'+url, function(data) {
			mongoData = data;
			console.log(data);
			displayData();
			$("#resultsDebug").empty();
	...
	var queryFilteredCombo = function() {
		...
		if (mID!=undefined)
		{
			$.getJSON('http://192.168.0.10:30025/mongoid/'+mID, function(data) {
				mongoData = data;
	...
	var DeleteById = function() {
		...
		if (mID!=undefined)
		{
				...
				$.ajax({
					url : "http://192.168.0.10:30025/mongoid/"+mID,
					type : "DELETE",
					data : {
						"id":mID
					},
	...
	var newRecord = function() {
		$.getJSON('http://192.168.0.10:30025/import', function(data) {
			alert(data);
		});
	};
